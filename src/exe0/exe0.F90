PROGRAM EXE0
  ...
  INTEGER :: P, Q, LWORK, ISTATS(4), NSWEEP, INFO
  INTEGER(8) :: NROT(2), WALLTM(3)
  DOUBLE PRECISION :: TOL, DSTATS(2)
  !DIR$ ATTRIBUTES ALIGN: 64:: IDADIM, ISTATS, NROT, WALLTM, DSTATS
...
CONTAINS
  ...
  SUBROUTINE READCL(H5FN, H5GN, H5RN)
    ...
    IF (COMMAND_ARGUMENT_COUNT() .GT. 3) STOP 'exe0.exe H5FN H5GN H5RN'
