subroutine sgendat(n, iseed, xs_f, xs_g, xl_x, xf, xg, xx, df, dg, dx, lda, xwork, info)
  ...
  real, intent(out) :: df(lda,n), dg(lda,n), dx(lda,n)
...
subroutine dgendat(n, iseed, xs_f, xs_g, xl_x, xf, xg, xx, df, dg, dx, lda, xwork, info)
