*> \brief \b XLARUV returns a vector of n random real numbers from a uniform distribution.
*
*  =========== DOCUMENTATION ===========
*
...
*> distribution (n <= 128).
*>
*> This is an auxiliary routine called by XLARNV and ZLARNV.
*> \endverbatim
*
*  Arguments:
*  ==========
