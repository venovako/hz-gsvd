...
*     .. Parameters ..
      ...
      PARAMETER          (ZERO=0.0E+0_WP, ONE=1.0E+0_WP, HALF=0.5E+0_WP)
*     ..
*     .. Local Scalars ..
      INTEGER            I, J
      REAL(WP)   ALPHA, TAU, WA, WB, WN
*     ..
*     .. External Subroutines ..
      EXTERNAL           XAXPY, XGEMV, XGER, XLARNV, XSCAL, XSYMV,
     $                   XSYR2, XERBLA
*     ..
*     .. External Functions ..
      REAL(WP)   XDOT, XNRM2
...
*        compute  y := tau * A * u
*
         CALL XSYMV( 'Lower', N-I+1, TAU, A( I, I ), LDA, WORK, 1, ZERO,
     $               WORK( N+1 ), 1 )
*
...
*
         CALL XSYR2( 'Lower', N-I+1, -ONE, WORK, 1, WORK( N+1 ), 1,
     $               A( I, I ), LDA )
   40 CONTINUE
*
...
*
         CALL XGEMV( 'Transpose', N-K-I+1, K-1, ONE, A( K+I, I+1 ), LDA,
     $               A( K+I, I ), 1, ZERO, WORK, 1 )
         CALL XGER( N-K-I+1, K-1, -TAU, A( K+I, I ), 1, WORK, 1,
     $              A( K+I, I+1 ), LDA )
*
...
*        compute  y := tau * A * u
*
         CALL XSYMV( 'Lower', N-K-I+1, TAU, A( K+I, K+I ), LDA,
     $               A( K+I, I ), 1, ZERO, WORK, 1 )
*
*        compute  v := y - 1/2 * tau * ( y, u ) * u
*
...
*
         CALL XSYR2( 'Lower', N-K-I+1, -ONE, A( K+I, I ), 1, WORK, 1,
     $               A( K+I, K+I ), LDA )
*
         A( K+I, I ) = -WA
         DO 50 J = K + I + 1, N
